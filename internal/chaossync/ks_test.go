...
// бит-идентичности Windows↔Linux). Перевыпущено 2026-09-01 под хаос-полями
// keystream-класса (NewKeyGen → DeriveFieldClass(FieldClassKeystream), задача
// «классы полей») и сверено Windows-билдом под wine; дальше — жёсткий гейт:
// любой дрейф решётки/whiten/выбора поля ломает тест.
const ksGoldenExpect = "f93da42028e82bf19d56c9ef50afda459e38bf4936e25afa09e2797b9c1c14b4"
