...
ROOT=Path('/files/VPN'); OUT=ROOT/'experiments/ks-recovery-20260908-v1'
REMOTE='/tmp/ks-recovery-20260908-v1'
...
r=Path('/tmp/ks-recovery-20260908-v1');r.mkdir(mode=0o700,exist_ok=False)
